document.querySelector('body').onclick = function(e) {
    ...
    if(e.target.id == 'q1'){
     ...
     if(e.target.id  == 'q'){  document.getElementById("defaultOpen").click();}
    
   }

    // document.querySelector('body').onclick = function(e) {
    //   if(e.target.className != 'closee') return
    //   let item = e.target.closest('.box1')
    //   item.style.display = 'none'
    //   document.querySelector('.section1').style.display = 'none';
    //   document.querySelector('.box2').style.display = 'block'
    ...
    // document.querySelector('body').onclick = function(e1) {
    //   if(e1.target.className != 'closee') return
    //   let item1 = e.target.closest('.box1')
    //   item1.style.display = 'none'
    //   document.querySelector('.section1').style.display = 'none';
    //   document.querySelector('.box2').style.display = 'block'
    //   document.getElementById("defaultOpen1").click();}

    //   document.querySelector('body').onclick = function(e2) {
    //     if(e2.target.className != 'close2') return
    //     let item2 = e.target.closest('.box1')
